...
<html>
    <head>
        <meta charset="utf-8">
        <title> All About  Villagers</title>
        <style>
        ...
        body{font-family:sans-serif;}
            h1{color:rgb(120, 235, 12);
                background-color:rgb(3, 15, 245);
                position:fixed;
                font-family:fantasy,noto-sans;
            top:-10px;
            right:109px;
            border:1px dashed rgb(49, 245, 10);
            font-size:23px;
            }
            
            
            body{background-color:rgb(3, 15, 245);}
            a{color:rgb(120, 235, 12);}
            .villy_foofoo{background-color:rgb(120, 235, 12);}
            h2{background-color:rgb(41, 214, 11);
                
            }
            h3{color:rgb(34, 204, 8);}
            a{font-family:serif;}
            h3{text-align:center;}
            .list{background-color:rgb(14, 199, 26);
            text-align:center;
            height:200px;
            overflow:auto;
            }
            ...
            #body{
                margin:1px 1px 1px;
                border:7px solid rgb(41, 214, 11);
            }
   ...
   <div id="body"> <h1>All About  Villagers! The Best Webpage</h1>
...
<p> This is a great example about how Villager songs are awesome!<p> 
